    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weekly_avg_reading_time', models.PositiveIntegerField(blank=True, help_text='분 단위', null=True)),
                ('annual_reading_amount', models.PositiveIntegerField(blank=True, help_text='권 단위', null=True)),
